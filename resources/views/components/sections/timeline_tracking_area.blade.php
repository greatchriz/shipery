                    ...
                    <ul>
                        <li>
                            ...
                            <div class="checkpoint__content">
                                <strong>Delivered, In/At Mailbox<span
                                        class="checkpoint__courier-name">USPS</span></strong>
                        ...
                        <li>
                            ...
                            <div class="checkpoint__content">
                                <strong>Arrived at Post Office<span
                                        class="checkpoint__courier-name">USPS</span></strong>
                                <div class="hint">ISC NEW YORK NY(USPS)</div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="checkpoint__icon intransit"></div>
                            <div class="checkpoint__content">
                                <strong>Departed Shipping Partner Facility<span
                                        class="checkpoint__courier-name">USPS</span></strong>
                        ...
                        <li>
                            ...
                            <div class="checkpoint__icon intransit"></div>
                            <div class="checkpoint__content">
                                <strong>Picked Up by Shipping Partner<span
                                        class="checkpoint__courier-name">USPS</span></strong>
                                <div class="hint">ISC CALIFORNIA NY(USPS)</div>
                            </div>
                        </li>
