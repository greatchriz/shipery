...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			<!-- Coming Soon -->
			<div class="bg-img-fix overflow-hidden" style="background:#fff url(/otherp/images/background/bg6.jpg); height: 100vh;">
				<div class="row gx-0">
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="index.html" class="logo"><img src="/otherp/images/logo/logo-full.png" alt="" class="width-230 light-logo"></a>
											<a href="index.html" class="logo"><img src="/otherp/images/logo/logofull-white.png" alt="" class="width-230 dark-logo"></a>
										</div>
