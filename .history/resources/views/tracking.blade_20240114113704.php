                ...
                >
                    <div class="prod-info white-clr">
                        <ul>
                            ...
                            <li class="p-10">
                                <span class="title-2">Sender Address:</span>
                                <span class="fs-16">{{ $item->senderAddress->street }}, <br> {{ $item->senderAddress->city }} <br>{{ $item->senderAddress->state }} {{ $item->senderAddress->zip }} <br>{{ $item->senderAddress->country }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
