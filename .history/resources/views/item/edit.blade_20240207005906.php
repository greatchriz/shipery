                            ...
                            <form class="needs-validation" novalidate="" action="{{ route('item.update', $item->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Sender and Receiver</h4>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <form>
                                                        <fieldset disabled="">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" value="{{ $item->sender->name }}">
                                                            </div>

                                                            <div class="mb-3">
                                                                <label class="form-label">Receiver</label>
                                                                <input type="text" class="form-control" value="{{ $item->receiver->name }}">
                                                            </div>
