...
<head>
	...
	<!-- Datatable -->
    <link href="/otherp/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
...
<body>
    ...
    ********************-->
	<div id="preloader">
		<div>
			<img src="/otherp/images/pre.gif" alt="">
		</div>
    </div>
    <!--*******************
        Preloader end
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/otherp/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/otherp/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/otherp/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/otherp/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/otherp/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/otherp/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="/otherp/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
												...
												<li>
													<div class="timeline-panel">
														<div class="media me-2">
															<img alt="image" width="50" src="/otherp/images/avatar/1.jpg">
														</div>
										...
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											<div class="header-info2 d-flex align-items-center">
												<div class="header-media">
													<img src="/otherp/images/user.jpg" alt="">
												</div>
											</div>
										</a>
										<div class="dropdown-menu dropdown-menu-end" style="">
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
														<img src="/otherp/images/user.jpg" class="avatar avatar-md" alt="">
														<div>
   ...
   <script src="/otherp/vendor/global/global.min.js"></script>
    <script src="/otherp/vendor/chart.js/Chart.bundle.min.js"></script>
	<!-- Apex Chart -->
	<script src="/otherp/vendor/apexchart/apexchart.js"></script>

    <!-- Datatable -->
    <script src="/otherp/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="/otherp/js/plugins-init/datatables.init.js"></script>
    ...
    <script src="/otherp/js/plugins-init/pickadate-init.js"></script>

	<!-- code-highlight -->
	<script src="/otherp/js/highlight.min.js"></script>
