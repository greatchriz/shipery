                    ...
                    <div class="prod-info white-clr">
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="fs-16">{{ $item->senderAddress->street }},</span>
                                <span class="fs-16">{{ $item->senderAddress->city }}</span>
                                <span class="fs-16">{{ $item->senderAddress->state }}{{ $item->senderAddress->zip }}</span>
                                <span class="fs-16">{{ $item->senderAddress->country }}</span>
                            </li>
