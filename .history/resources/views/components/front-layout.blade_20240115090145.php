        ...
        <section class="client_logo_area">
            <div class="container">
                <div class="client_slider owl-carousel">
                    <div class="item">
                        <img
                            src="img/client-logo/client-1.png"
                            alt=""
                        />
                    </div>
                    <div class="item">
                        <img
                            src="img/client-logo/client-2.png"
                            alt=""
                        />
                    </div>
                    <div class="item">
                        <img
                            src="img/client-logo/client-3.png"
                            alt=""
                        />
                    </div>
                    <div class="item">
                        <img
                            src="img/client-logo/client-4.png"
                            alt=""
                        />
                    </div>
                    <div class="item">
                        <img
                            src="img/client-logo/client-5.png"
                            alt=""
                        />
                    </div>
                </div>
