                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="needs-validation" novalidate="">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <x-dashboard.validation-form  inputName="name" inputPlaceholder="Enter Sender Name" inputFeedback="Please Enter Sender Name"/>


{{--
                                        <div class="mb-3 row">
                                            <label class="col-lg-4 col-form-label" for="name">Username
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="name" placeholder="Enter a username.." required="">
